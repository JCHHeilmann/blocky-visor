...
<div class="space-y-6">
	<h1 class="text-xl font-bold text-text-primary">Blocky Configuration</h1>
	...
	{:else}
		<div class="grid gap-6 xl:grid-cols-[1fr_320px]">
			...
			<Card>
				<h2 class="mb-4 text-lg font-semibold text-text-primary">Configuration File</h2>
				<ConfigEditor />
			</Card>
			...
			<div class="space-y-6">
				<Card>
					<h2 class="mb-4 text-lg font-semibold text-text-primary">Service Status</h2>
					<ServiceControl />
				</Card>
