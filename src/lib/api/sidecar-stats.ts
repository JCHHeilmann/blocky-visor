...
import type { SidecarStatsResponse, SidecarTimelineBucket, SidecarLogsResponse } from '$lib/types/api';

export type StatsRange = 'today' | 'yesterday' | '7d' | '30d';

export async function fetchStats(range: StatsRange = 'today'): Promise<SidecarStatsResponse> {
