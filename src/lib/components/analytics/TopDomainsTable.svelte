...
{#if domains.length === 0}
	<div style="min-height: {containerMinHeight}px" class="flex items-center justify-center">
...
{:else}
	<div class="space-y-2" style="min-height: {containerMinHeight}px">
		{#each displayDomains as entry, i}
			<div class="flex items-center gap-3 text-sm" style="min-height: {ROW_HEIGHT - 8}px">
