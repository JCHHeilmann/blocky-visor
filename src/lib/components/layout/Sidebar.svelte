...
<nav class="flex h-full w-full flex-col bg-surface-primary border-r border-surface-border">
	<!-- Logo — h-14 matches the header height -->
	<div class="flex h-14 shrink-0 items-center gap-3 border-b border-surface-border px-4">
		<div class="flex h-8 w-8 items-center justify-center rounded-lg bg-accent-600">
	...
	<div class="border-t border-surface-border px-3 py-3">
		<div class="{collapsed ? 'flex justify-center' : 'px-3'}">
			<StatusBadge
				...
				label={collapsed ? undefined : (blockingStore.connected ? 'Connected' : 'Disconnected')}
			/>
		</div>
	</div>
</nav>
